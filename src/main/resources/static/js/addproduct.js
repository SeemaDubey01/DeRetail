...
function validateProductList(){
	...
	wsProductDetailArray.forEach(function(item,index){
		$('#productListForm').append('<input type="hidden" name="productArray['+index+'].barcode" value="'+item.productCode+'">');
    	$('#productListForm').append('<input type="hidden" name="productArray['+index+'].brand" value="'+item.brand+'">');
    	$('#productListForm').append('<input type="hidden" name="productArray['+index+'].sku" value="'+item.SKU+'">');
    	$('#productListForm').append('<input type="hidden" name="productArray['+index+'].prodName" value="'+item.productName+'">');
    	$('#productListForm').append('<input type="hidden" name="productArray['+index+'].category" value="'+item.productDescr+'">');
	});
}
...
function WSProductDetail(wsProductCode, wsBrand, wsSKU, wsProductName, wsProductDescr){
    ...
    this.brand = wsBrand;
    this.SKU = wsSKU;
    this.productName = wsProductName;
